...
public void placeAllShipsRandomly()
    ...
    public  boolean place(Ship flotila )
{
   do
   {
       if ( flotila ==null )
      {
          throw new  IllegalArgumentException("Illegal null argument for Ship object.");
        }
          ...
          for ( int m =0; m <flotila.getLength (); m++ )
            {
              ...
              if (dir)
               {
                  if ( (j+flotila.getLength ()<ships.length))
                ...
                {
                   if (i+flotila.getLength ()<ships.length)
     ...
     */
     boolean extraPoints (int n, int m ) 
     {
      ...
      /**
     *  checks initial placing point  and later vertical or horizontal placing points of the ship to the ocean . Though it is possible to place all ships in the first rectangle if we delete second part of the code :)
      ...
      public boolean pointCheck (int n, int m ) 
    {
        ...
        /**
     *  used for OceanTest class
     *  @param  none
     * @return  returns ship array
     */
  ...
  /**
    ...
    public void setShipSunk ( int ship) {
         if (ship <0) {
			throw new IndexOutOfBoundsException(
					"Illegal  argument for  sunk Ship.");
